...
import { ADD_AS_NOTE, MESSAGE_LIST_BY_CHAT_ID, READ_ALL_MESSAGES, WHATSAPP_MESSAGE_LIST } from '../../../DAL';
...
const MessageList = ({ navigation, route }) => {
  ...
  const getMemberList = async () => {
    let res = await WHATSAPP_MESSAGE_LIST({ navigation, token, userId: member?.chatId })
    setLoader(false);
