          ...
          if (!!editedComment?.parent_comment) {
            ...
            if (index > -1) {
              ...
              if (childIndex > -1) {
                childList.splice(childIndex, 1, {
                  ...
                  is_liked: user?._id == data?.action_by ? editedComment?.is_liked : nList[index].child_comment[childIndex]?.is_liked,
                });
                nList.splice(index, 1, { ...nList[index], child_comment: childList });
              }
            }
            ...
            if (index > -1) {
              nList.splice(index, 1, {
                ...nList[index],
                like_count: editedComment?.comment_like_count,
                is_liked: user?._id == data?.action_by ? editedComment?.is_liked : nList[index]?.is_liked
              })
            }
          }
          return {
