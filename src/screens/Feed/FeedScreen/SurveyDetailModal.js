...
const SurveyDetailModal = forwardRef(
  ({token, member, navigation, timezone}, ref) => {
    ...
    const updateSurveyData = (updatedDate, actionId) => {
      setData(old => {
        ...
        if (updatedDate?._id == old?.feed_obj?._id) {
          ...
          obj.survey_selected_options = !!updatedDate?.survey_selected_options
            ? [...updatedDate?.survey_selected_options]
            : [];
                    ...
                    <ScrollView showsVerticalScrollIndicator={false}>
                      <View style={{padding: 10}}>
                        ...
                        <View style={__style.headingTextView}>
                          ...
                          <View style={__style.descView}>
                            {data?.feed_obj?.survey_info?.survey_status ==
                            'expired' ? (
                              <MyText>{'Expired'}</MyText>
                            ) : (
                              <MyText>
                                {convertTimezone2(
                                  data?.feed_obj?.survey_info?.expiry_date_time,
                                  timezone,
                          ...
                          <View style={{}}>
                            <FlatList
                              ...
                              renderItem={({item, index}) => {
                                let totalAnswers = item?.options.reduce(
                                  (total, obj) => total + obj?.answers.length,
                                  0,
                                );
                                return (
                                  <View
                                    ...
                                    <MyText
                                      ...
                                      {index + 1}. {item?.question_statement}
                                    </MyText>
