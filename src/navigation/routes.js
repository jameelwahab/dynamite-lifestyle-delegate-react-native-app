const routes = {
  ...
  missionMemberList: 'MISSION_Member_List',
  ...
  manageProgrammeAccessScreen: 'MANAGE_PROGRAMME_ACCESS_SCREEN',
  agreementConfigurationScreen: 'AGREEMENT_CONFIGURATION_SCREEN',
  ...
  delegateReportAccountablityTrackerScreen:
    'DELEGATE_REPORT_ACCOUNTABILTY_TRACKER_SCREEN',
