...
export const ChildComponents = {
	...
	"goal_statement_incomplete": {
		...
		params: {
			value: "goal_statement_incomplete", parentValue: "member_goal_statement",
	...
	"goal_statement_responded": {
		...
		params: {
			value: "goal_statement_responded", parentValue: "member_goal_statement",
	...
	"self_image_completed": {
		...
		params: {
			value: "self_image_completed", parentValue: "self_image",
	...
	"self_image_incompleted": {
		...
		params: {
			value: "self_image_incompleted", parentValue: "self_image",
	...
	"self_image_responded": {
		...
		params: {
			value: "self_image_responded", parentValue: "self_image",
