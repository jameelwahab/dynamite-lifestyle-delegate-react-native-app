...
export const GET_SALE_PAGE_LIST_FOR_BOOKING = ({token, navigation, search}) => {
  return invokeApi({
...
export const GET_BOOKING_TIME_SLOTS_BY_CONSULTANT = ({
  token,
  navigation,
  date,
  consultant_id,
...
export const BOOKING_CONSULTANT_LIST_V1 = ({
  token,
  navigation,
  body: {data_type, member_type, search_text, delegates_type, consultant_id},
}) => {
  return invokeApi({
...
export const BOOKING_NOTES_ADD = ({
  token,
  navigation,
  body: {add_as_personal_note, booking_id, note},
}) => {
  return invokeApi({
