...
export const GET_ASSESSMENT_LIST =
  ({ token, navigation, page, searchText }) => {
    return invokeApi({
...
export const ASSESSMENT_NOTE_LIST = ({ token, navigation, assessmentId, type }) => {
  return invokeApi({
...
export const ASSESSMENT_NOTE_ADD = ({ token, navigation, assessmentId, type, message }) => {
  return invokeApi({
...
export const ASSESSMENT_NOTE_UPDATE = ({ token, navigation, assessmentId, type, noteId, message }) => {
  return invokeApi({
...
export const ASSESSMENT_NOTE_DELETE = ({ token, navigation, assessmentId, type, noteId }) => {
  return invokeApi({
