...
export const GET_MEMBER_LIST_FOR_PAYMENT_REQUEST = ({
  token,
  navigation,
  searchText,
  memberType,
...
export const GET_PAYMENT_TEMPLATE_AND_PROGRAMMES_LIST = ({
  token,
  navigation,
}) => {
  return invokeApi({
...
export const PAY_RECURRING = ({
  token,
  navigation,
  body: {payment_request_slug, source_token},
}) => {
  return invokeApi({
...
export const CONFIRM_RECURRING_PAYMENT = ({
  token,
  navigation,
  body: {payment_request_slug, price_id, recurring_price_id, subscription_id},
}) => {
  return invokeApi({
...
export const GET_CLIENT_SECRET_FOR_PAY_ONETIME = ({
  token,
  navigation,
  body: {payment_request_slug},
}) => {
  return invokeApi({
...
export const GET_PAYEMENT_DETAIL = ({token, navigation, requestId}) => {
  return invokeApi({
...
export const GET_PAYMENT_CONFIGURATION_DETAIL = ({token, navigation, id}) => {
  return invokeApi({
...
export const UPDATE_AGREEMENT_CONFIGURATION = ({
  token,
  navigation,
  slug,
  data,
  ...
  return invokeApi({
    path: `api/payment_request/agreement_config/${slug}`,
    method: 'PUT',
    token,
    navigation,
    postData: data,
...
export const GET_PROGRAMS_AND_EVENTS = ({token, navigation, id}) => {
  return invokeApi({
    path: `api/payment_request/get_programs_and_event_data/${id}?list_data_type=program`,
    method: 'GET',
    token,
    navigation,
  });
...
export const UPDATE_PROGRAMS_AND_EVENTS = ({token, navigation, id, data}) => {
  return invokeApi({
    path: `api/payment_request/update_event_or_program_data/${id}?update_type=program`,
    method: 'POST',
    token,
    navigation,
    postData: data,
