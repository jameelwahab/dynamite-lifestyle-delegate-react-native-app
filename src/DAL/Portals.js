...
export const GET_PORTAL_CHAT_MESSAGE_LIKES = ({
  token,
  navigation,
  id,
  page,
...
export const GET_PORTAL_EXISTING_CHAT_BY_VIDEO_ID = ({
  token,
  navigation,
  videoId,
  page,
...
export const GET_PORTAL_USER_LIST = ({
  token,
  navigation,
  slug,
  searchText,
...
export const GET_PORTAL_TEMPLATES = ({
  token,
  navigation,
  slug,
  searchText,
...
export const UPDATE_PORTAL_EVENT = ({
  token,
  navigation,
  formdata,
  eventSlug,
...
export const UPLDATE_PORTAL_LOCK_EVENT = ({
  token,
  navigation,
  eventSlug,
  body: {
...
export const UPLDATE_PORTAL_TIMER_CONGIF = ({
  token,
  navigation,
  eventSlug,
  body: {
...
export const ASSIGN_PROGRAM_MEMBERS_TO_PORTAL = ({
  token,
  navigation,
  event_id,
  program_id,
...
export const PORTAL_UPDATE_EVENT = ({
  token,
  navigation,
  eventSlug,
  formdata,
...
export const PORTAL_MEMBER_LISTING = ({
  token,
  navigation,
  eventId,
  searchText,
...
export const MEMBER_LISTING_ADDING = ({
  token,
  navigation,
  eventId,
  searchText,
...
export const PORTAL_VIDEO_QUESTION_CONFIG = ({
  token,
  navigation,
  videoId,
  body: {module_type, question_configration},
}) => {
  return invokeApi({
...
export const GET_MEMBER_LIST_FOR_PERSONAL_NOTES = ({
  token,
  navigation,
  searchText,
}) => {
...
export const ADD_PERSONAL_NOTE_FOR_PORTAL = ({
  token,
  navigation,
  memberId,
  note,
...
export const ADD_PERSONAL_NOTE_FOR_PORTAL_CHAT = ({
  token,
  navigation,
  messageId,
}) => {
