...
const MissionRewardView = ({
  badges = [],
  showEarnedBadges = true,
  badgesEarned = [],
  duration = 0,
  durationTitle,
  totalCoins = 0,
      ...
      <View>
        <Row alignItems="center">
          <Flex alignItems="center" style={{marginRight: 10}}>
            <Image source={ic_tropy} style={{height: 20, width: 20}} />
          </Flex>
    ...
    <View>
        ...
        <BoxView style={{marginTop: 15}}>
          <Row
            ...
            <Row alignItems="center" justifyContent="flex-end">
              ...
              <Text style={[main.regular, {fontFamily: fonts.medium}]}>
                {'Mission Duration'}
              </Text>
            </Row>
      ...
      {(!!acheivedCoins ||
        ...
        <View style={{marginVertical: 10, marginTop: 15}}>
          <MyText type="bold" fontSize={18} color={colors.primary}>
            {'Rewards & Badges'}
          </MyText>
          <BoxView style={{marginTop: 10}}>
                            ...
                            <Row alignItems="center" justifyContent="flex-end">
                              ...
                              <Flex alignItems="center">
                                <MyImage
                                  source={{
                                    uri:
                                      S3_URL + item?.general_icon?.thumbnail_1,
                                  }}
                                  style={{height: 20, width: 20}}
                                />
                              </Flex>
              ...
              <>
                <Row paddingHorizontal={5} alignItems="center">
                  ...
                  <Flex flex={1} alignItems="flex-end">
                    <Row alignItems="center" justifyContent="flex-end">
                      <Text style={[main.regular, {fontFamily: fonts.medium}]}>
                        {numFormatter(totalCoins, 1)}
                      </Text>
                    </Row>
                  </Flex>
                </Row>
                {!!acheivedCoins && <Divider mt={10} mb={15} />}
              </>
            )}
            ...
            {!!acheivedCoins && (
              <Row paddingHorizontal={5} alignItems="center">
                <Row alignItems="center" justifyContent="flex-end">
                  <Flex alignItems="center" style={{marginRight: 10}}>
                    <Image source={ic_coin_s} style={{height: 20, width: 20}} />
                  </Flex>
                  <Text style={[main.regular, {fontFamily: fonts.medium}]}>
                    {'Coins Earned'}
                  </Text>
